                ...
                <div class="modal-body">
                    <form id="add-user-form" novalidate accept-charset="utf-8">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" maxlength="70" name="email-input" id="email-input" placeholder="Email" required>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="username-input">Username</label>
                                <input type="text" class="form-control" maxlength="70" name="username-input" id="username-input" placeholder="Username" required>
                            </div>
                            <div class="form-group col-md-6">
                ...
                <div class="modal-body">
                    <form id="edit-user-form" novalidate accept-charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" maxlength="70" id="edit-username-input" placeholder="Username" required>
                        </div>
                        <div class="form-group">
