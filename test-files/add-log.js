...
function generateContactNumber() {
  ...
  let contactNumber = "09" + randomNumber;
...
function generateTemperature() {
  ...
  let randomDecimal =
    Math.floor(
      Math.random() * (38 * precision - 36 * precision) + 1 * precision
    ) /
    (1 * precision);
  return randomDecimal + 35;
}
